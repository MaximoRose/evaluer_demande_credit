...
# Kernel ici : https://www.kaggle.com/code/jsaguiar/lightgbm-7th-place-solution
...
def get_train_test(path, num_rows = None):
    ...
    df = df[df['AMT_INCOME_TOTAL'] < 20_000_000]  # Max income in test is 4M; train has a 117M value
...
def get_bureau(path, num_rows= None):
    ...
    agg_length.rename({feat: 'LL_CREDIT_DURATION' + feat for feat in features}, axis=1, inplace=True)
